...
app.post('/api/research/analyze/jobs', deepResearchController.createDeepResearchAnalysisJob);
app.get('/api/research/analyze/jobs', deepResearchController.listDeepResearchAnalysisJobs);
app.get('/api/research/analyze/jobs/:jobId', deepResearchController.getDeepResearchAnalysisJob);
app.get('/api/research/analyze/jobs/:jobId/result', deepResearchController.getDeepResearchAnalysisJobResult);
